...
const outDir = join(__dirname, '..', '..', 'dimos_ext', 'overwatch_patrol');
mkdirSync(outDir, { recursive: true });

const pythonModule = `# AUTO-GENERATED — do not hand-edit.
...
writeFileSync(join(outDir, 'events.py'), pythonModule);
console.log(`✓ wrote ${join(outDir, 'events.py')}`);
